...
@section('page_title', 'User Notifications')
...
@section('scripts')
    ...
    <script>
        $(function() {
            const table = window.LaravelDataTables["dataTable-user-notifications"];
            ...
            table.on("click", ".btn-mark-read", function(e) {
                e.preventDefault();
            ...
            table.on("click", ".btn-mark-unread", function(e) {
                e.preventDefault();
            ...
            $(".datatablead").on("input", ".search", function() {
