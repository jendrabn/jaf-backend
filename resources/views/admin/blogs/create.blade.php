                    ...
                    <form action="{{ route('admin.blogs.store') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-sm mt-3"
                                   ...
                                   type="text"
                                   value="{{ old('featured_image_description') }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control select2 {{ $errors->has('user_id') ? 'is-invalid' : '' }}"
                                    ...
                                    @foreach ($authors as $id => $name)
                                        <option @selected(old('user_id', auth()->user()->id) == $id)
                                                value="{{ $id }}">{{ $name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control select2 {{ $errors->has('blog_category_id') ? 'is-invalid' : '' }}"
                                    ...
                                    @foreach ($categories as $id => $name)
                                        <option @selected(old('blog_category_id') == $id)
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control select2 {{ $errors->has('tag_ids') ? 'is-invalid' : '' }}"
                                    ...
                                    @foreach ($tags as $id => $name)
                                        <option @selected(in_array($id, old('tag_ids', [])))
                                                value="{{ $id }}">
                                            {{ $name }}
                                        </option>
                                    @endforeach
        ...
        Dropzone.options.imagesDropzone = {
            ...
            init: function() {
                @if (isset($product) && $product->featured_image)
                    let file = {!! json_encode($product->featured_image) !!}
