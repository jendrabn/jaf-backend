                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card promo-type-card"
                                    ...
                                    <div class="card-body text-center">
                                        <input {{ old('promo_type') == 'limit' ? 'checked' : '' }}
                                               hidden
                                               id="limit"
                                               name="promo_type"
                                               type="radio"
                            ...
                            <div class="col-md-4">
                                <div class="card promo-type-card"
                                     id="period-card">
                                    <div class="card-body text-center">
                                        <input {{ old('promo_type') == 'period' ? 'checked' : '' }}
                                               hidden
                                               id="period"
                                               name="promo_type"
                                               type="radio"
                            ...
                            <div class="col-md-4">
                                <div class="card promo-type-card"
                                     id="product-card">
                                    <div class="card-body text-center">
                                        <input {{ old('promo_type') == 'product' ? 'checked' : '' }}
                                               hidden
                                               id="product"
                                               name="promo_type"
                                               type="radio"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control @error('discount_amount_limit') is-invalid @enderror"
                                               ...
                                               step="0.01"
                                               type="number"
                                               value="{{ old('discount_amount_limit') }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="mt-2">
                                            <div class="form-check form-check-inline">
                                                <input {{ old('discount_type_limit') == 'fixed' ? 'checked' : '' }}
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input {{ old('discount_type_limit') == 'percentage' ? 'checked' : '' }}
                                                       class="form-check-input"
                                                       id="percentage-limit"
                                                       name="discount_type_limit"
                                                       type="radio"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control @error('limit_per_user_limit') is-invalid @enderror"
                                               ...
                                               step="1"
                                               type="number"
                                               value="{{ old('limit_per_user_limit') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control @error('discount_amount_period') is-invalid @enderror"
                                               ...
                                               step="0.01"
                                               type="number"
                                               value="{{ old('discount_amount_period') }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="mt-2">
                                            <div class="form-check form-check-inline">
                                                <input {{ old('discount_type_period') == 'fixed' ? 'checked' : '' }}
                                                       class="form-check-input"
                                                       id="fixed-period"
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input {{ old('discount_type_period') == 'percentage' ? 'checked' : '' }}
                                                       class="form-check-input"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control @error('limit_per_user_period') is-invalid @enderror"
                                               ...
                                               step="1"
                                               type="number"
                                               value="{{ old('limit_per_user_period') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control @error('discount_amount_product') is-invalid @enderror"
                                               ...
                                               step="0.01"
                                               type="number"
                                               value="{{ old('discount_amount_product') }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="mt-2">
                                            <div class="form-check form-check-inline">
                                                <input {{ old('discount_type_product') == 'fixed' ? 'checked' : '' }}
                                                       class="form-check-input"
                                                       id="fixed-product"
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input {{ old('discount_type_product') == 'percentage' ? 'checked' : '' }}
                                                       class="form-check-input"
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control select2 w-100 @error('product_ids') is-invalid @enderror"
                                            ...
                                            @foreach ($products as $product)
                                                <option {{ collect(old('product_ids'))->contains($product->id) ? 'selected' : '' }}
                                                        value="{{ $product->id }}">
                                                    {{ $product->name }}
                                                </option>
                                            @endforeach
...
@push('scripts')
    <script>
        let selectedPromoType = "{{ old('promo_type') }}";
        ...
        function selectPromoType(type) {
            ...
            $('.dynamic-field-group')
                ...
                .prop('disabled', true); // penting: hidden tidak terkirim

            // set radio + card state
            $('#' + type).prop('checked', true);
            $('#' + type + '-card').addClass('selected');

            // show + enable only the chosen group
            $('#dynamic-fields').show();
            $('#' + type + '-fields')
                .show()
                .find('input, select, textarea')
        ...
        // buka kembali berdasarkan old('promo_type') jika ada
